...
function discoverDashboard() {
    ...
    try {
        ...
        var sendPacket = new DatagramPacket(sendBuf, sendBuf.length, InetAddress.getByName("255.255.255.255"), 10065);
...
var postData = {
  nozzles: [{ id: nozzleName, isVacActive: false, isPicking: false, isPlacing: false, hasComponent: false }],
};
